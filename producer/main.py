...
def main(each_process):
    ...
    print(f"time taken by process:{each_process} {end-start}")
...
if __name__ == '__main__':
    ...
    for each_process in range(NUM_PROCESS):
        p = multiprocessing.Process(target=main, args={each_process})
        processes.append(p)
        p.start()
